export default {
  ...
  servers: [{ url: "https://api.papermc.io" }],
  paths: {
    "/v2/projects": {
      get: {
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: true,
            schema: { pattern: "[0-9.]+-?(?:pre|SNAPSHOT)?(?:[0-9.]+)?", type: "string" },
          },
        ],
        responses: {
          "200": {
    ...
    "/v2/projects/{project}/versions/{version}/builds": {
      get: {
        tags: ["version-builds-controller"],
        ...
        responses: {
          "200": {
            description: "OK",
            content: {
              "application/json": { schema: { $ref: "#/components/schemas/BuildsResponse" } },
            },
          },
        },
      },
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: true,
            schema: { pattern: "\\d+", type: "integer", format: "int32" },
          },
        ],
        responses: {
          "200": {
        ...
        responses: {
          "200": {
            ...
            content: {
              ...
              "application/java-archive": { schema: { type: "object" } },
            },
          },
        },
      },
    ...
    "/v2/projects/{project}/version_group/{family}": {
      get: {
        tags: ["version-family-controller"],
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/VersionFamilyResponse" },
              },
            },
          },
        },
    ...
    "/v2/projects/{project}/version_group/{family}/builds": {
      get: {
        tags: ["version-family-builds-controller"],
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/VersionFamilyBuildsResponse" },
              },
            },
          },
        },
  ...
  components: {
    schemas: {
      BuildResponse: {
        type: "object",
        properties: {
          project_id: { pattern: "[a-z]+", type: "string", example: "paper" },
          project_name: { type: "string", example: "Paper" },
          version: {
            pattern: "[0-9.]+-?(?:pre|SNAPSHOT)?(?:[0-9.]+)?",
            type: "string",
            example: "1.18",
          },
          build: { pattern: "\\d+", type: "integer", format: "int32", example: 10 },
          time: { type: "string", format: "date-time" },
          channel: { type: "string", enum: ["default", "experimental"] },
          promoted: { type: "boolean" },
          changes: { type: "array", items: { $ref: "#/components/schemas/Change" } },
          downloads: {
            type: "object",
            additionalProperties: { $ref: "#/components/schemas/Download" },
          },
        },
      },
      BuildsResponse: {
        ...
        properties: {
          ...
          builds: { type: "array", items: { $ref: "#/components/schemas/VersionBuild" } },
        },
      },
      Change: {
        type: "object",
      ...
      Download: {
        type: "object",
        properties: {
          name: { pattern: "[a-z0-9._-]+", type: "string", example: "paper-1.18-10.jar" },
          sha256: {
            pattern: "[a-f0-9]{64}",
            type: "string",
      ...
      ProjectResponse: {
        ...
        properties: {
          project_id: { pattern: "[a-z]+", type: "string", example: "paper" },
          project_name: { type: "string", example: "Paper" },
          version_groups: { type: "array", items: { type: "string" } },
      ...
      VersionFamilyBuildsResponse: {
        ...
        properties: {
          ...
          builds: {
            type: "array",
            items: { $ref: "#/components/schemas/VersionFamilyBuild" },
          },
        },
      },
      ...
      VersionResponse: {
        ...
        properties: {
          ...
          builds: { type: "array", items: { type: "integer", format: "int32" } },
        },
      },
    },
  },
